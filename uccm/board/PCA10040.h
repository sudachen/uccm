...
#define UCCM_BOARD_LEDS (LED1,PO_17,LEG_OPEN_DRAIN), (LED2,PO_18,LEG_OPEN_DRAIN), (LED3,PO_19,LEG_OPEN_DRAIN), (LED4,PO_20,LEG_OPEN_DRAIN), NIL
#define UCCM_BOARD_LEDS_COUNT C_LIST_LENGTH(UCCM_BOARD_LEDS)

#define UCCM_BOARD_BUTTONS (BUTTON1,PO_13,LEG_PULL_UP), (BUTTON2,PO_14,LEG_PULL_UP), (BUTTON3,PO_15,LEG_PULL_UP), (BUTTON4,PO_16,LEG_PULL_UP), NIL
